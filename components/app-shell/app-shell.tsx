...
export function AppShell({ user, children }: { user: { name?: string | null; email?: string | null; image?: string | null }; children: React.ReactNode }) {
  return (
      ...
      <div className="app-main">
        <header className="app-header">
          ...
          <details className="user-menu">
            ...
            <div className="user-menu-popover"><Link href="/profile">Profile & settings</Link><form action={logoutAction}><button type="submit">Log out</button></form></div>
          </details>
        </header>
